...
exports.GUARDRAIL_PROFILES = exports.GUARDRAIL_RULES = void 0;
exports.GUARDRAIL_RULES = {
    'RULE-1': {
        id: 'RULE-1',
        trigger: '/memory',
...
exports.GUARDRAIL_PROFILES = {
    'strict': {
        name: 'Strict',
        activeRules: Object.keys(exports.GUARDRAIL_RULES),
