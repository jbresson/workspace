...
## Layout
- `/helpers/extensions/`: Pi extension source code (Auto-discovery, Lazy-load).
...
2. **Dependency Isolation**: Extensions in `/helpers/extensions/` must maintain their own `package.json` or requirements to avoid project-root pollution.
