...
| `task_phase2` | Cycling | Medium | Execute & Validate | Verified findings → `offloadFinding` |
...
| `task_phase6` | Retro | Low | Procedure Audit | Token efficiency metrics → Insights |
...
**Workflow:**
1. Call `task_phase0` → Result is missing "False Win Risks".
...
- **Phase Specifications**: `memory/mindbase/processes/TASK_EXECUTION_WITH_TOOLS.md`
